...
public class TestGetAllPhotosApi extends BaseSetup {
  ...
  @Test
  public void showAllPhotosToUser()
    ...
    // Assert.assertEquals(photos.get(0).getPhotographer().getphotographerId(),1234);
    // Assert.assertEquals(photos.get(0).getPhotographer().getphotographerName(),"test");
    // Assert.assertEquals(photos.get(0).getPhotographer().getphotographerUrl(),"@test");
