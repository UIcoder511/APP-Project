...
public class TestGetAllLikedPhotosByUsernameApi extends BaseSetup {
	...
	public void getLikedPhotos() throws JsonParseException, JsonMappingException, IOException {
		...
		String getAllLikedPhotosInResponse = given().when().queryParam("username", user).get("/get-liked-photos").then()
	...
	// negative tests
	@Test(priority = 2)
	public void getUserLikedPhotosWithInvalidUser() throws JsonParseException, JsonMappingException, IOException {
